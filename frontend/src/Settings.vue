  ...
  <div>
    ...
    <div v-if="showSettingsPanel" class="settings-panel">
      ...
      <div class="toggle-container">
        <label class="toggle-label">Process In Browser </label>
      ...
      <div class="toggle-container">
        <label class="toggle-label">Display Debug View</label>
        <label class="toggle-switch">
          <input type="checkbox" v-model="secondToggleSwitch" />
          <div class="toggle-switch-background">
            <div class="toggle-switch-handle"></div>
          </div>
        </label>
...
const secondToggleSwitch = ref(false); // New ref for the second toggle switch
...
watch(secondToggleSwitch, (newValue, oldValue) => {
  console.log(`Second toggle switch changed from ${oldValue} to ${newValue}`);
  setDebug(newValue);
  //store.setAnotherSetting(newValue); // Replace with your own logic
});
