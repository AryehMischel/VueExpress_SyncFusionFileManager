...
import { isVRDevice } from "./utils/vrUtils.js";
...
import { toolbarSettings as nonVRToolbarSettings } from "./fileManagerSettings.js";
import { toolbarSettings as VRToolbarSettings } from "./fileManagerSettingsVR.js";
...
const logger = new Logger("appLogger", true);
