...
class KTX2Loader extends Loader {
	...
	async detectSupportAsync( renderer ) {
		...
		this.workerConfig = {
			...
			astcHDRSupported: await renderer.hasFeatureAsync( 'texture-compression-astc' ),
	...
	detectSupport( renderer ) {
		...
		if ( renderer.isWebGPURenderer === true ) {
			...
			this.workerConfig = {
				...
				astcHDRSupported: renderer.hasFeatureAsync( 'texture-compression-astc' ),
	...
	async _createTexture( buffer, config = {} ) {
		...
		console.log('container vkFormat: ', container.vkFormat);
